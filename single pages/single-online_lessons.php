...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-xxxlarge w3-theme-d5 d4t"><b>Online Lesson</b></h1>
	...
	<p class=" align-left side-padding d5t bold"> by <a href="https://twitter.com/<?php the_field('author')?>" target="_blank"> <?php the_field('author')?></a></p>
		</div>
